...
export const NounsGlasses = ({ className = '' }: { className?: string }) => (
  <svg className={className} width="160" height="60" viewBox="0 0 160 60" fill="none" xmlns="http://www.w3.org/2000/svg" shapeRendering="crispEdges">
